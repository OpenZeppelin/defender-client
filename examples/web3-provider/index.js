...
function defenderSender(creds, websockets) {
  ...
  const base = websockets
    ? new Web3.providers.WebsocketProvider(`wss://goerli.infura.io/ws/v3/${process.env.INFURA_PROJECT_ID}`)
    : new Web3.providers.HttpProvider(`https://goerli.infura.io/v3/${process.env.INFURA_PROJECT_ID}`);
