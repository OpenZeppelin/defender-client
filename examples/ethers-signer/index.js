...
async function main() {
  ...
  const signer = new DefenderRelaySigner(process.env.RELAYER_API_KEY, process.env.RELAYER_API_SECRET, provider, { from: '0x387b06760c45dc01edbb202d54f8624440c6e025', speed: 'fast' });
